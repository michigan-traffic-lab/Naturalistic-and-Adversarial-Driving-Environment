...
def cal_dis_with_start_end_speed(v_start, v_end, acc, time_interval=1):
    # Calculate the travel distance with start and end speed and acc
    if v_end == global_val.v_low or v_end == global_val.v_high:
