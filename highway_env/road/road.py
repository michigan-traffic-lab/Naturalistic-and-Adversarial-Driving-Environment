...
class Road(Loggable):
    ...
    def get_BV(self, vehicle, count, observation_range=100000):
        """
        Get BV according to lane distance within the observation range.

        Args:
            vehicle: the vehicle want to get observation.
            count: maximum number of vehicles to observe.
    ...
    def get_BV_EU(self, vehicle, count, observation_range=100000):
        """
        Get BV according to Euclidean distance within the observation range.
